module tests {
     ...
     */
    function shallowCopyArray(a: Array<Object>): Array<Object> {
        var len = a.length;
        var copy = Array(len);
        for (var i = 0; i < len; i++) {
            copy[i] = a[i];
     ...
     */
    function shallowCopyArrayBasedOnKeys(a: Array<Object>): Array<Object> {
     ...
     */
    function shallowCopyArrayWithSlice(a: Array<Object>): Array<Object> {
        return a.slice(0);
    }
     ...
     */
    function createArray(total: number): Array<Object> {
     ...
     */
    function createArrayWithHoles(total: number): Array<Object> {
        var result = new Array(total);
        for (var i = 0; i < total; i++) {
            var key = "W" + i.toString();
    ...
    function convertToNumber(s: string): number {
        var result = 0;
     ...
     */
    function createArrayWithPush(total: number): Array<Object> {
        var result = [];
        for (var i = 0; i < total; i++) {
     ...
     */
    function createObject(total: number): MyMap {
     ...
     */
    function shallowCopyObject(o: Object): Object {
