/// <reference path="vanilla.ts" />
describe("vanilla.services.DateService.getFirstOfPreviousMonth", function () {
    it("Should handle year transition", function () {
        var ds = new vanilla.services.DateService();
        var result = ds.getFirstOfPreviousMonth(new Date(2015, 0, 12, 0, 0, 0, 0));
        expect(new Date(2014, 11, 1, 0, 0, 0, 0)).toEqual(result);
    });
});
describe("vanilla.services.DateService.getPrecedingDatesOfMonth", function () {
...
describe("vanilla.services.DateService.getSucceedingDatesOfMonth", function () {
...
describe("vanilla.viewmodels.Calendar.initialize", function () {
