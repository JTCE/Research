...
describe("vanilla.calendar.services.DateService.getFirstOfPreviousMonth", function () {

    it("Should handle year transition", function () {
        var ds = new vanilla.calendar.services.DateService();
...
describe("vanilla.calendar.services.DateService.getPrecedingDatesOfMonth", function () {
...
describe("vanilla.calendar.services.DateService.getSucceedingDatesOfMonth", function () {
...
describe("vanilla.calendar.viewmodels.Calendar.initialize", function () {

    it("Should fill Calendar", function () {
        var calendar = new vanilla.calendar.components.Calendar();
