...
(function (app) {
    ...
    var App = (function () {
        ...
        App.prototype.registerTypes = function () {
            var _this = this;
            this.ioc.registerService("ng.IAngularStatic", function () {
                return angular;
            });
            this.ioc.registerService("angular.IHttpService", function () {
                return _this.injector.get("$http");
            });
            this.ioc.registerService("angular.IQService", function () {
                return _this.injector.get("$q");
            });
            this.ioc.registerService("app.services.ILocationService", function () {
                return new app.services.LocationService();
            });
            this.ioc.registerService("app.services.IValidationService", function () {
                return new app.services.ValidationService();
            });
            this.ioc.registerService("app.services.IExtendService", function () {
                return new app.services.ExtendService(_this.ioc);
            });
            ...
            this.ioc.registerComponent("app.models.dashboard.Dashboard", "/dashboard/view.html", true, function () {
                return new app.models.dashboard.Dashboard(_this.ioc.resolve("app.services.ICoreService"));
            });
