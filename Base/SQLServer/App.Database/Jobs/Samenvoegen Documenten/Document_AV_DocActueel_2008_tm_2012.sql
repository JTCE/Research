...
declare @MaxDocumentDate date = '2013-1-1'
declare @MinDocumentDate date = '2008-1-1'
...
insert into SV_Log ([Message]) values ('DocActueel: [' + cast(isnull(@@ROWCOUNT, 0) as varchar(50)) +  '] records uit de [MA] tabellen [PWDocument] en overgezet naar de backlog.')
